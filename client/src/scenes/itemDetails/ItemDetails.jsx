...
const ItemDetails = () => {
  ...
  const itemPrice = useSelector((state) => state.cart.idItems.attributes?.price);
  const itemDesc = useSelector((state) => state.cart.idItems.attributes?.longDescription[0].children[0].text);
  const itemCate = useSelector((state) => state.cart.idItems.attributes?.category);
      ...
      <Box display="flex" flexWrap="wrap" columnGap="40px">
        ...
        <Box flex="1 1 50%" mb="40px">
          ...
          <Box>
            ...
            <Typography>CATEGORIES: {itemCate}</Typography>
          </Box>
        </Box>
      </Box>
